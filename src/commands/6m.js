...
exports.run = async (client, message, args) => {
  ...
  while(trial < 3){
	  try {
		...
		var date2 = parseInt(date - 15552000);
		...
		var avg = parseFloat((total/(15552000/86400)).toFixed(2));
		...
		var avg2 = parseFloat((sum/(15552000/86400)).toFixed(2));
		...
		const buffer = finalCanvas.toBuffer();
			...
			try{
				...
				.setAuthor(`6-Month Chart (Page #` + page.toString() + `)\n`, message.author.displayAvatarURL(), 'https://www.last.fm/user/'+name+`/library/albums?date_preset=LAST_180_DAYS&page=` + page.toString())
...
exports.help = {
  name: `6m`,
  description: `**6**-**M**ONTH CHART: fetches a 5x10 6-month chart`,
  usage: `6m <page #>`
};
