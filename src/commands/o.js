...
exports.run = async (client, message, args) => {
	...
	*/
	...
	console.log("Overall Chart Queue Debug:");
	console.log("Artist Array Length:", artistArray.length);
	console.log("Album Array Length:", albumArray.length);
	console.log("First few artists:", artistArray.slice(0, 3));
	console.log("First few albums:", albumArray.slice(0, 3));
