...
exports.run = async (client, message, args) => {
  try {
      const Notifs = client.sequelize.import(`../models/WNotifs.js`);
      ...
      if (!notif) {
        ...
        `you steal a crown from someone. Make sure to enable your ` +
        ...
        `\`${client.config.prefix}notifywin\` again.`);
      } else {
...
exports.help = {
  name: `notifywin`,
  description: `NOTIFY WINS: Toggles the bot's ability to send you a DM after you steal a crown.`,
  usage: `notifywin`,
  notes: `Use \`-notifyloss\` to toggle alerts for crowns you have lost.`
};
