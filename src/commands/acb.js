...
exports.run = async (client, message) => {
  try {
	...
	if (authorPos !== -1){
		desc += `\nTotal number of album crowns: **${users.length}**`;
	}
	else{
		desc += `\n\nTotal number of album crowns: **${users.length}**`;
	}
    const embed = new MessageEmbed()
      .setTitle(`:crown:  album crown leaderboard  :crown:`)
...
exports.help = {
  name: `acb`,
  description: `**A**LBUM **C**ROWN**B**OARD: Provides you a list of people with the most album crowns in the guild.`,
  usage: `acb`
};
