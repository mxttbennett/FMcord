...
exports.run = async (client, message, args) => {
  ...
  try {
    ...
    await message.reply(`your #` + mult + ` album of the past 6 months: **` + data.topalbums.album[0].artist.name + `** — ***` + data.topalbums.album[0].name + `*** with **` + data.topalbums.album[0].playcount + `** plays`, { file: buffer });
...
exports.help = {
  name: `a6m`,
  description: `**A**LBUM IN **6** **M**ONTHS: Shows the album you have for the specified ranking in the past 6 months. If no number is provided, it chooses randomly from your top 500 albums of the 6-month period.`,
  usage: `a6m <#>`
};
